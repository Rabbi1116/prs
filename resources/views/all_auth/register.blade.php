...
<head>
  ...
  <title>IT WAY BD| Registration</title>
...
<div class="register-box">
  <div class="card card-outline card-primary">
    <div class="card-header text-center">
      <a href="" class="h1"><b>IT WAY BD</b></a>
    </div>
    <div class="card-body">
      <p class="login-box-msg">Register a new Employe</p>
      ...
      <form action="{{ route('emp-register') }}" method="post">
        ...
        <div class="input-group mb-3">
          <input type="Number" name="or_mobile" class="form-control" placeholder="Another Mobile Number">
          <div class="input-group-append">
            <div class="input-group-text">
              <span class="fas fa-phone"></span>
            </div>
